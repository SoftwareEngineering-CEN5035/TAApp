...
export default function CreateCourse(){
    ...
    return (
        <div className='w-[100%] h-[100%] flex bg-blue-400 justify-center items-center'>
            ...
            <form onSubmit={handleSubmit} className="bg-slate-100 border-black border-4 rounded-md items-center shadow-md h-[70vh] w-[30vw] flex flex-col">
                <label className='text-4xl font-light mt-2 underline underline-offset-8'>Create new Course</label>
                ...
                <label className="mt-5 text-lg font-extralight">Professor</label>
                <Select
                    closeMenuOnSelect={false}
                    options={professorList}
                    onChange={handleProfessorChange}
                    className="mt-1 w-[20vw]"
                    required
                    placeholder="Please select a Professor"
                />

                <label className="mt-5 text-lg font-extralight">Class Type</label>
                <Select
                    closeMenuOnSelect={false}
                    options={typeList}
                ...
                <label className="mt-5 text-lg font-extralight">Teacher's Assitants</label>
                <Select
                    closeMenuOnSelect={false}
                    isMulti
                    options={taList}
                ...
                />
                <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white text-2xl flex justify-center mt-7 items-center w-[5vw] h-[35px] rounded-lg pointer"> <IoSaveOutline/></button>
            </form>
        </div>
    )
}